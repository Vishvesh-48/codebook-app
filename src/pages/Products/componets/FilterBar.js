                  ...
                  <ul className="text-slate-700 dark:text-slate-100">
                    <li className="mt-1 mb-5">
                      ...
                      <div className="flex items-center my-1">
                          <input onChange={() => dispatch({type:"SHORT_BY", payload :{ shortBy: "lowTohigh"}})} checked={state.shortBy === "lowTohigh" || false} id="price-sort-1" type="radio" value="" name="price-sort" className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 dark:bg-gray-700 dark:border-gray-600" />
                          <label htmlFor="price-sort-1" className="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Price - Low to High</label>
                      </div>
                      <div className="flex items-center my-1">
                          <input onChange={() => dispatch({type:"SHORT_BY", payload :{ shortBy: "highTolow"}})} checked={state.shortBy === "highTolow" || false} id="price-sort-2" type="radio" value="" name="price-sort" className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 dark:bg-gray-700 dark:border-gray-600" />
                    ...
                    <li className="mt-1 mb-5">
                      ...
                      <div className="flex items-center my-1">
                          <input onChange={() => dispatch({type: "RATING",payload :{rating :"4STARSABOVE"}})} checked={state.rating === "4STARSABOVE"} id="rating-sort-1" type="radio" value="" name="rating-sort" className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 dark:bg-gray-700 dark:border-gray-600" />
                          <label htmlFor="rating-sort-1" className="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">4 Stars & Above</label>
                      </div>
                      <div className="flex items-center my-1">
                          <input onChange={() => dispatch({type: "RATING",payload :{rating :"3STARSABOVE"}})} checked={state.rating === "3STARSABOVE"} id="rating-sort-2" type="radio" value="" name="rating-sort" className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 dark:bg-gray-700 dark:border-gray-600" />
                          <label htmlFor="rating-sort-2" className="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">3 Stars & Above</label>
                      </div>
                      <div className="flex items-center my-1">
                          <input onChange={() => dispatch({type: "RATING",payload :{rating :"2STARSABOVE"}})} checked={state.rating === "2STARSABOVE"} id="rating-sort-3" type="radio" value="" name="rating-sort" className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 dark:bg-gray-700 dark:border-gray-600" />
                          <label htmlFor="rating-sort-3" className="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">2 Stars & Above</label>
                      </div>
                      <div className="flex items-center my-1">
                          <input onChange={() => dispatch({type: "RATING",payload :{rating :"1STARSABOVE"}})} checked={state.rating === "1STARSABOVE"} id="rating-sort-4" type="radio" value="" name="rating-sort" className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 dark:bg-gray-700 dark:border-gray-600" />
