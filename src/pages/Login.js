...
export const Login = () => {
  ...
  async function handleLoginGeust() {
    email.current.value = process.env.REACT_APP_LOGINID
  ...
  return (
    <main>
      ...
      <button onClick={handleLoginGeust} className="mt-3 cursor-pointer text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-3 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Login As Guest</button>
    </main>
  )
}
